  ...
  $(function () {
    ...
    function addField () {
      ...
      $addField = $([
        ...
        '    <h3>Alegeți tipul de câmp nou</h3>',
        '    <p class="part-obs">Alegeți tipul de câmp nou pe care doriți să-l creați.</p>',
        '    <form class="field-types" id="radio-select-input-type">',
        '      <div class="modal-padding">',
        '        <div class="radio-group">',
        '          <input type="radio" id="text-input" value="text" name="in-type" required />',
        '          <label for="text-input">Text tip de intrare</label>',
        '        </div>',
        '        <div class="radio-group">',
        ...
        '        <button type="submit" id="radio-to-continue">Continuă</button>',
        '        <a href="javascript:void(0)" class="close-modal">Închide</a>',
        '      </footer>',
        '    </form>',
        '  </div>',
    ...
    function editField () {
      ...
      if ($zone.find('.fa-form-group').length === 0 && $this.find('i').is('.fa-pencil')) {
        alert('Trebuie să creați cel puțin o intrare înainte de a edita una dintre ele!');
        return;
      }
        ...
        .find('.input-edit-trigger')
          .on('click', function () {
            ...
            $editField = $([
              ...
              '    <h3>Modificați câmpul...</h3>',
              '    <p class="part-obs">Editați atributele de mai jos ale câmpului:</p>',
              '    <form id="atributes-edition">',
              '      <div class="modal-padding">',
              '        <div class="form-group">',
              '          <label for="edit-input-label">Eticheta:</label>',
              '          <input id="edit-input-label" value="' + label + '" required />',
              '        </div>',
              '        <div class="form-group placeholder-edit">',
              '          <label for="edit-input-placeholder">Substitut:</label>',
              '          <input id="edit-input-placeholder" value="' + placeholder + '" />',
              '        </div>',
              '        <div class="form-group required-check">',
              '          <label for="is-required-modal">Necesar?</label>',
              '          ' + requiredCheckbox,
              '          <label for="is-required-modal" class="pseudo-checkbox-edition"></label>',
              '        </div>',
              '      </div>',
              '      <footer class="form-footer">',
              '        <button type="submit" id="edit-finish">Salvează</button>',
              '        <a href="javascript:void(0)" class="close-modal">Închide</a>',
              '      </footer>',
              '    </form>',
              '  </div>',
            ...
            if (inType === 'number') {
              ...
              $editField = $([
                ...
                '        </div>',
                '        <div class="form-group">',
                '          <label for="edit-input-max">Lungimea maximă a intrării:</label>',
                '          <input type="text" id="edit-input-max" value="' + maxLgt + '" />',
                '        </div>',
                '        <div class="form-group">',
                '          <label for="edit-input-min">Lungimea mină a intrării:</label>',
            ...
            if (inType === 'select') {
              $editField = $([
                ...
                '        </div>',
                '        <div class="form-group">',
                '          <label for="edit-vals-select">Substitut:</label>',
