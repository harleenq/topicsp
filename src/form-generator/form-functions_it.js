  ...
  $(function () {
    ...
    function addField () {
      ...
      $addField = $([
        ...
        '          <label for="text-input">Tipo di input testo.</label>',
        '        </div>',
        '        <div class="radio-group">',
        ...
        $this
          .find('i.fa')
            .removeClass('fa-check')
              .addClass('fa-pencil')
                .attr('title', 'Clicca qui per modificare un campo.')
        ;
      ...
      $this
        .find('i.fa')
          .removeClass('fa-pencil')
            .addClass('fa-check')
              .attr('title', 'Clicca qui per salvare.')
      ;
        ...
        .find('.input-edit-trigger')
          .on('click', function () {
            ...
            $editField = $([
              ...
              '    <p class="part-obs">Modifica gli attributi del campo qui sotto:</p>',
            ...
            if (inType === 'number') {
              ...
              $editField = $([
                ...
                '        </div>',
                '        <div class="form-group">',
                '          <label for="edit-input-max">Lunghezza massima dell:</label>',
                '          <input type="text" id="edit-input-max" value="' + maxLgt + '" />',
                '        </div>',
                '        <div class="form-group">',
                '          <label for="edit-input-min">Lunghezza minima dell:</label>',
    ...
    function removeField () {
      ...
      if ($zone.find('.fa-form-group').length === 0 && $this.find('i').is('.fa-minus')) {
        alert('Devi creare almeno un input prima di rimuovere uno!');
        return;
      }
      ...
      if ($this.find('i').is('.fa-check')) {
        $this
          .find('i.fa')
            .removeClass('fa-check')
              .addClass('fa-minus')
                .attr('title', 'Clicca qui per rimuovere un campo.')
        ;
      ...
      $zone
        .find('.input-remove-trigger')
          .on('click', function () {
            ...
            console.info('[Generatore] Un input è stato rimosso!');
          })
      ;
    ...
    var generate = function (type) {
      ...
      console.info('[Generatore] The selected mode was: ' + type);
      ...
      if (type === 'textarea') {
        $addField
          .find('.modal')
            .append([
              '<p class="part-obs">Hai scelto una textarea!</p>',
              '<p class="part-obs">Completa i campi sottostanti con i dettagli del tuo nuovo campo.</p>',
              '<form class="configure-input">',
              '  <div class="modal-padding">',
              '    <div class="form-group">',
      ...
      if (type === 'date') {
        $addField
          .find('.modal')
            .append([
              '<p class="part-obs">Hai scelto un input data!</p>',
              '<p class="part-obs">Completa i campi sottostanti con i dettagli del tuo nuovo campo.</p>',
              '<form class="configure-input">',
              '  <div class="modal-padding">',
              '    <div class="form-group">',
      ...
      if (type === 'color') {
        $addField
          .find('.modal')
            .append([
              '<p class="part-obs">Hai scelto un input colore!</p>',
              '<p class="part-obs">Completa i campi sottostanti con i dettagli del tuo nuovo campo.</p>',
              '<form class="configure-input">',
              '  <div class="modal-padding">',
              '    <div class="form-group">',
      ...
      if (type === 'number') {
        $addField
          .find('.modal')
            .append([
              '<p class="part-obs">Hai scelto un input numerico!</p>',
              '<p class="part-obs">Completa i campi sottostanti con i dettagli del tuo nuovo campo.</p>',
              '<form class="configure-input">',
              '  <div class="modal-padding">',
              '    <div class="form-group">',
              ...
              '    </div>',
              '    <div class="form-group">',
              '      <label for="input-max">Lunghezza massima:</label>',
              '      <input type="text" id="input-max" value="20" />',
              '    </div>',
              '    <div class="form-group">',
              '      <label for="input-min">Lunghezza minima:</label>',
      ...
      if (type === 'selectU') {
        $addField
          .find('.modal')
            .append([
              '<p class="part-obs">Hai scelto un input di selezione normale!</p>',
              '<p class="part-obs">Completa i campi sottostanti con i dettagli del tuo nuovo campo.</p>',
              '<form class="configure-input">',
              '  <div class="modal-padding">',
              '    <div class="form-group">',
              ...
              '    </div>',
              '    <div class="form-group">',
              '      <label for="input-vals">Valori di campo (separarli da interruzione di riga):</label>',
      ...
      if (type === 'selectM') {
        $addField
          .find('.modal')
            .append([
              '<p class="part-obs">Hai scelto un input di selezione multipla!</p>',
              '<p class="part-obs">Completa i campi sottostanti con i dettagli del tuo nuovo campo.</p>',
              '<form class="configure-input">',
              '  <div class="modal-padding">',
              '    <div class="form-group">',
    ...
    var generateCode = function (codeType) {
      ...
      if (codeType === 'topiccode') {
        ...
        var POSTgeneratedCode = [
          ...
          ' * Generatore (2.0) fatto da Luiz (http://ajuda.forumeiros.com/u60563)',
          ' * Tradotto in lingua italiana da Chanp',
          ' */',
          '<- -->',
          '<head>',
          '  <meta charset="UTF-8">',
